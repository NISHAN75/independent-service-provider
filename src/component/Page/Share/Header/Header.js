...
const handlelogOut=()=>{
  ...
  return (
        <Navbar sticky="top" bg="light shadow-lg" expand="lg">
          <Container>
            <Navbar.Brand as={Link} to="/" className=" d-flex align-items-center font-bold">
            ...
            <Navbar.Collapse id="basic-navbar-nav">
              <Nav className="mx-auto">
                ...
                <Nav.Link href="home#services"><span className="link-text">Services</span></Nav.Link>
                <Nav.Link as={Link} to="/about"><span className="link-text">About Me</span></Nav.Link>
